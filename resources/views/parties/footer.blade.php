    ...
    <div class="container">
     <div class="row">
       ...
       <div class="col-lg-4 col-sm-6">
         <h6 class="mt-10 text-white mb-30 text-uppercase">Subscribe to Our Newsletter</h6>
               ...
               <form action="php/mailchimp-action.php" method="POST" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate">
                <div id="msg"> </div>
                 ...
                 <div id="mce-responses" class="clear">
                   ...
                   <div class="clear">
                     <button type="submit" name="submitbtn" id="mc-embedded-subscribe" class="mt-20 button button-border form-button">  Get notified </button>
                   </div>
                 </form>
               </div>
               </div>
         ...
         <div class="mt-20 footer-widget">
           <div class="row">
             ...
             <div class="col-lg-6 col-md-6 text-start text-md-end">
               <div class="mt-10 social-icons color-hover">
                <ul>
